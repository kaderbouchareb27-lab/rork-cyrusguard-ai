...
export default function PrivacyScreen() {
  ...
  const content = language === 'fr' ? {
    ...
    sections: [
      ...
      { heading: '3. Traitement des données par l\'intelligence artificielle', body: 'Les contenus soumis à l’analyse (images, textes et URLs) sont transmis de manière sécurisée à notre service d’intelligence artificielle uniquement pour réaliser l’analyse de fraude demandée. Ils ne sont pas conservés après l’analyse ni utilisés à des fins commerciales. Vous êtes informé de ce traitement avant votre première analyse via une fenêtre de consentement explicite.' },
    ...
    sections: [
      ...
      { heading: '3. AI Data Processing', body: 'Content submitted for analysis (images, text, and URLs) is securely transmitted to our artificial intelligence service solely to perform the requested fraud analysis. It is not retained after analysis or used for commercial purposes. You are informed of this processing before your first analysis through an explicit consent dialog.' },
