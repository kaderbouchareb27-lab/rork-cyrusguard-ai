...
export default function FaqPageScreen() {
  ...
  const faqs = language === 'fr' ? [
    ...
    { q: 'Combien de scans puis-je faire gratuitement ?', a: 'Les utilisateurs gratuits disposent de 2 crédits d\'analyse. Chaque scan ou analyse d\'URL consomme un crédit. Pour des analyses illimitées, passez à Premium.' },
    ...
    { q: 'How many free scans can I do?', a: 'Free users get 2 analysis credits. Each scan or URL analysis uses one credit. For unlimited analyses, upgrade to Premium.' },
