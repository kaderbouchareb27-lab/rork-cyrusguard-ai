...
export default function TermsScreen() {
  ...
  const content = language === 'fr' ? {
    ...
    sections: [
      ...
      { heading: '7. Traitement des données par l\'IA', body: 'CyrusGuard utilise l\'API d\'OpenAI pour analyser les contenus soumis par l\'utilisateur. En utilisant CyrusGuard, vous acceptez que vos données soient traitées par OpenAI conformément à leur politique de confidentialité disponible sur openai.com/privacy. Les données ne sont pas conservées après l\'analyse.' },
    ...
    sections: [
      ...
      { heading: '7. AI Data Processing', body: 'CyrusGuard uses the OpenAI API to analyze content submitted by the user. By using CyrusGuard, you agree that your data will be processed by OpenAI in accordance with their privacy policy available at openai.com/privacy. Data is not retained after analysis.' },
