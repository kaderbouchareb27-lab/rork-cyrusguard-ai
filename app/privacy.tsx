...
export default function PrivacyScreen() {
  ...
  const content = language === 'fr' ? {
    ...
    sections: [
      ...
      { heading: '3. Traitement des données par l\'intelligence artificielle', body: 'CyrusGuard AI utilise un service d\'intelligence artificielle sécurisé pour analyser le contenu que vous soumettez (images, textes, URLs). Les données sont envoyées de manière sécurisée (chiffrement TLS) uniquement pour l\'analyse de fraude. Le service d\'IA ne conserve pas les données transmises au-delà du traitement immédiat et ne les utilise pas pour entraîner des modèles. Aucune donnée personnelle identifiable n\'est volontairement transmise au service d\'IA. Vous êtes informé de ce traitement avant votre première analyse via une fenêtre de consentement explicite.' },
    ...
    sections: [
      ...
      { heading: '3. Third-Party AI Data Processing', body: 'CyrusGuard AI uses a secure artificial intelligence service to analyze the content you submit (images, texts, URLs). Data is securely transmitted (TLS encryption) solely for fraud analysis purposes. The AI service does not retain data transmitted beyond immediate processing and does not use it to train models. No personally identifiable information is intentionally transmitted to the AI service. You are informed of this processing before your first analysis via an explicit consent dialog.' },
